...
class SfpHandler(Handler):
    def __init__(self,args,dataset):
        ...
        if self.args.pattern_type != 'sequence':
            print("SFP only works for sequence dataset")
            exit(0)
        ...
        self.point_num = len(self.dataset.points)

        self.fixed_traj_len = 4 # must be even and >= 4
        ...
        self.k_thres = (self.args.k * self.args.num_participants) / (self.clients_num)
    ...
    def __trimTraj(self,idx):
        ...
        '''
        traj = list(self.dataset[idx].data)
